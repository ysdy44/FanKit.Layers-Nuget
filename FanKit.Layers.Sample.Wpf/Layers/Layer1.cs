...
namespace FanKit.Layers.Sample
{
    public abstract class Layer1
    {
        ...
        public Symbols ChildrenSymbol => this.Children.Count > 0 ? Symbols.Folder : Symbols.NewFolder;
        ...
        public Brush SelectBrush => this.selectMode == SelectMode.Deselected ? Brushes.Black : Brushes.White;
